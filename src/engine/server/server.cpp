...
/* INFECTION MODIFICATION START ***************************************/
	...
	SetFireDelay(INFWEAPON_SPIDER_HAMMER, 700);
	SetFireDelay(INFWEAPON_SPIDER_GRENADE,400);
	SetFireDelay(INFWEAPON_SPIDER_RIFLE, 400);
	...
	SetFireDelay(INFWEAPON_HUNTER_SHOTGUN, 400);
	SetFireDelay(INFWEAPON_SPIDER_SHOTGUN, 50);
	...
	SetAmmoRegenTime(INFWEAPON_SPIDER_GRENADE, 400);
	SetAmmoRegenTime(INFWEAPON_SPIDER_RIFLE, 400);
	SetAmmoRegenTime(INFWEAPON_HUNTER_SHOTGUN, 100);
	SetAmmoRegenTime(INFWEAPON_SPIDER_SHOTGUN, 10);
	SetAmmoRegenTime(INFWEAPON_SPIDER_HAMMER, 750);
	...
	SetMaxAmmo(INFWEAPON_SPIDER_GRENADE, 20);
	SetMaxAmmo(INFWEAPON_SPIDER_RIFLE, 20);
	SetMaxAmmo(INFWEAPON_SPIDER_HAMMER, 20);
	SetMaxAmmo(INFWEAPON_SPIDER_SHOTGUN, 50);
	SetMaxAmmo(INFWEAPON_HUNTER_SHOTGUN, 5);
	...
	SetClassAvailability(PLAYERCLASS_SPIDER, 2);
